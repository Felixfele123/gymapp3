var tetris = false
setInterval(()=>{
    var n = document.getElementById("tetris");
	if(n === null){
		tetris = false
	}
    if(n != null && tetris !== true){
        setTimeout(()=> {

            const grid = document.querySelector('.tgrid')
            let squares = Array.from(document.querySelectorAll('.tgrid div'))
            ...
            function undraw() {
              current.forEach(index => {
                squares[currentPosition + index].classList.remove('ttetromino')
            ...
            const displaySquares = document.querySelectorAll('.tmini-grid div')
            ...
            function displayShape() {
              ...
              displaySquares.forEach(square => {
                square.classList.remove('ttetromino')
              ...
              for (let i = 0; i < 199; i +=width) {
                ...
                if(row.every(index => squares[index].classList.contains('taken'))) {
                  ...
                  row.forEach(index => {
                    ...
                    squares[index].classList.remove('ttetromino')
